...
Tuned Lens~\citep{belrose2023eliciting} trains per-layer affine probes to stabilize early-layer decoding, and introduces \emph{prediction trajectory} and \emph{prediction depth}---the direct conceptual precursors to our First Correct Layer (FCL) metric.
