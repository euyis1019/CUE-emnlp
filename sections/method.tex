...
\begin{equation}
\label{eq:csd}
\Phi_{\mathrm{C}}^\ell(\mathbf{h}^\ell) \!=\! \mathrm{softmax}\!\Big(W_u \!\circ\! \mathrm{LN} \!\circ\! f_{L\text{-}1} \!\circ\! \cdots \!\circ\! f_{\ell+1}\!\big(\mathbf{h}^\ell\big|_T\big)\Big)\bigg|_{\mathcal{T}}
\end{equation}
%
