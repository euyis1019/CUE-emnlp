...
\usepackage{listings}
\usepackage{etoc}          % local table of contents for appendix
...
% Local TOC: show only section-level entries (depth 1) for the appendix
\etocsettocstyle{\noindent\textbf{Table of Contents}\par\smallskip}{}
\etocsettocdepth{1}          % sections only, no subsections
